...
class profileController extends Controller
{
    ...
    function update(Request $request)
    {
        $request->validate([
            ...
            '_foto.mimes' => 'Foto hanya boleh jpeg,jpg,png,gif',
            '_email.required' => 'Email wajib diisi',
            '_email.email' => 'Format email tdk valid'
        ]);
        ...
        return redirect()->route('profile.index')->with('success', 'berhasil melakukan update data');
    }
}
